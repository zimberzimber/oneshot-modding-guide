...
Because of that, I kept adding functionality I'd want to have to make my life easier, and are now sharing some of it with you.
This article describes what the script gives, and how to set it up.
